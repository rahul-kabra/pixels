...
export class RogueComponent implements OnInit {
  character = {
    ...
    description: "Armed with the ability to temporarily absorb others’ powers and memories, this Mississippi runaway started her career as a villain before joining the X-Men to fight for good.",
    prev: "quill",
    next: "sasuke-uchiha"
  }
