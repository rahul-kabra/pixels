...
export class KakashiHatakeComponent implements OnInit {
  character = {
    ...
    description:
      "Kakashi Hatake earned the moniker of The Copy Ninja by his sheer genius and effective usage of the Sharingan. A master tactician and a highly powerful shinobi, he became Konoha's Sixth Hokage.",
    prev: "jean-grey",
    next: "loki",
  };
