...
export class MartianManhunterComponent implements OnInit {
  character = {
    ...
    description: "One of the last surviving members of his species, the Martian Manhunter wields such powers as the ability to shape-shift, telepathy, flight, inivisibility, phasing, super-strength and Martian vision.",
    prev: "magneto",
    next: "naruto-uzumaki"
  }
