...
export class MagnetoComponent implements OnInit {
  character = {
    ...
    description:
      "The powerful mutant Magneto uses his ability to control magnetic fields to help mutants replaces humans as the dominant species, as he believes in their superiority.",
    prev: "loki",
