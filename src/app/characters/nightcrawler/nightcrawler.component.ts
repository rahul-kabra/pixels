...
export class NightcrawlerComponent implements OnInit {
  character = {
    ...
    description:
      "Kurt Wagner is a prominent meber of the X-Men and former member and leader of Excalibur. He possessess the Neyaphemiam ability of teleportation, as well as incredible agility, wall scaling and a prehensile tail.",
    prev: "naruto-uzumaki",
    next: "obito-uchiha",
  };
