...
export class JeanGreyComponent implements OnInit {
  character = {
    ...
    description: "One of the five original X-Men, Jean Grey is an omega-level mutant telekinetic and telepath and has gained near limitless powers as a recurrent host of the Phoenix Force.",
    prev: "itachi-uchiha",
    next: "kakashi-hatake"
  }
