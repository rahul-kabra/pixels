...
export class SasukeUchihaComponent implements OnInit {
  character = {
    ...
    description:
      "Lone survivor of the Uchiha clan, Sasuke betrayed Konoha to follow his own obsession with revenge. But eventually, he regretted his past actions and atoned for it and pledged to save the Leaf Village from the shadows.",
    prev: "rogue",
    next: "scarlet-witch",
  };
